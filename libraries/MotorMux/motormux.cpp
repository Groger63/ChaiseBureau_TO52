...
Motor::Motor(int _MOTOR_BACK,int _MOTOR_FORWARD, int _BUTTON_BACK, int _BUTTON_FORWARD, int _POTENTIOMETER, int _MARGIN_MOTOR, ShiftReg *SR, CustomType4051Mux *mux)
{
  POTENTIOMETER=_POTENTIOMETER;
